  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Text" do
        expect {
          post texts_url, params: { text: valid_attributes }
        }.to change(Text, :count).by(1)
      end

      it "redirects to the created text" do
        post texts_url, params: { text: valid_attributes }
        expect(response).to redirect_to(text_url(Text.last))
      end
    end

    context "with invalid parameters" do
      it "does not create a new Text" do
        expect {
          post texts_url, params: { text: invalid_attributes }
        }.to change(Text, :count).by(0)
      end
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested text" do
        text = Text.create! valid_attributes
        patch text_url(text), params: { text: new_attributes }
        text.reload
      ...
      it "redirects to the text" do
        ...
        patch text_url(text), params: { text: new_attributes }
        text.reload
        expect(response).to redirect_to(text_url(text))
      end
    end
    ...
    context "with invalid parameters" do
      ...
      it "renders a response with 422 status (i.e. to display the 'edit' template)" do
        text = Text.create! valid_attributes
        patch text_url(text), params: { text: invalid_attributes }
        expect(response).to have_http_status(:unprocessable_entity)
      end
